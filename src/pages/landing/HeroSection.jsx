...
const HeroSection = () => {
    return (
        <section className="w-full h-screen bg-[url(/23.jpg)] bg-center bg-cover flex items-end p-4 sm:p-6 lg:p-8 text-white">
            <div className="absolute inset-0 bg-black/40 top-0 bottom-0"></div>
            <div className="h-[75%] w-full flex flex-col justify-between max-w-7xl mx-auto relative">
