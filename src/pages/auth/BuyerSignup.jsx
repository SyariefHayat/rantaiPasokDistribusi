                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <Select onValueChange={(value) => handleSelectChange('jenisKomoditas', value)}>
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="jagung-pakan">Jagung Pakan</SelectItem>
                                                    <SelectItem value="jagung-konsumsi">Jagung Konsumsi</SelectItem>
                                                    <SelectItem value="jagung-industri">Jagung Industri</SelectItem>
                                                    <SelectItem value="jagung-organik">Jagung Organik</SelectItem>
                                                    <SelectItem value="semua-jenis">Semua Jenis Jagung</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
