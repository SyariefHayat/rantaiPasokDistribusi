...
const AboutUs = () => {
    ...
    return (
        <section className="w-full lg:min-h-screen flex flex-col gap-3 lg:gap-10 lg:mt-10 p-6 lg:p-8">
            <dl className="w-full hidden lg:flex lg:justify-between">
                {stats.map((stat) => (
            ...
            <div className="w-full h-full flex flex-col justify-center gap-8 lg:gap-0">
                <div className="w-full max-w-4xl mx-auto lg:mx-0">
                    <h2 className="text-xl sm:text-2xl lg:text-2xl xl:text-3xl font-light leading-relaxed lg:leading-[1.4] text-gray-900">
                ...
                <div className='w-full max-w-2xl lg:max-w-lg ml-auto'>
                    <p className="text-sm leading-relaxed lg:leading-[1.5] text-gray-700">
