...
const DashboardMain = () => {
  ...
  const [recentActivities] = useState([
    { id: 1, type: 'order', message: 'Pesanan baru 500kg jagung pipilan dari PT Charoen', time: '5 menit lalu', status: 'new' },
    ...
    { id: 4, type: 'inquiry', message: 'Inquiry harga untuk 1 ton jagung pakan dari Bali', time: '5 jam lalu', status: 'pending' }
  ]);
  ...
  const [marketPrices] = useState([
    { variety: 'Jagung Pipilan Kering', price: 4200, change: +150, region: 'Jawa Timur' },
    { variety: 'Jagung Pakan Ternak', price: 3800, change: -50, region: 'Lampung' },
    { variety: 'Jagung Konsumsi', price: 4500, change: +200, region: 'Jawa Tengah' }
  ]);
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Dashboard Petani Jagung</h1>
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-between p-3 text-left border rounded-lg hover:bg-green-50 hover:border-green-200 transition-colors">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-medium">Tambah Produk Jagung</span>
                </div>
              </button>
          ...
          <div className="bg-white rounded-xl shadow-sm border p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2 border-t">
                <p className="text-sm text-gray-600 italic">"Jagung berkualitas tinggi, selalu tepat waktu pengiriman"</p>
