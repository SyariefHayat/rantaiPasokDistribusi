        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                    Masukkan email dan password Anda untuk mengakses akun dan mulai berbelanja.
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="w-full bg-white hover:bg-gray-50 disabled:bg-gray-100 border border-gray-300 hover:border-gray-400 disabled:border-gray-200 text-gray-700 font-medium py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-[1.02] disabled:hover:scale-100 shadow-sm hover:shadow-md disabled:shadow-none flex items-center justify-center cursor-pointer"
                    >
